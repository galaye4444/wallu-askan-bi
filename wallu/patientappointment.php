                ...
                <div class="container">
                    <div class="row reng">
                        ...
                        <div class="col-lg-12">
                            <div class="appointment" align="center">
                                ...
                                <form method="post" action="" name="frmpatapp" onSubmit="return validateform()"
                                    ...
                                    <ul class="row  ">
                                        ...
                                        <li class="col-sm-6">
                                            <label><input placeholder="ville" type="text" class="form-control"
                                        ...
                                        <li class="col-sm-6">
                                            <label>
                                                <input placeholder="numero de telephone" type="text" class="form-control"
                            ...
                            {        
                                ?>
                                        <li class="col-sm-6">
                                            <label>
                                                <input placeholder="nom utilisateur" type="text" class="form-control"
                            ...
                            ?>
                                ...
                                ?>
                                        ...
                                        <li class="col-sm-6">
                                            <label>
                                                <input placeholder="date rendez-vs" type="text" class="form-control"
                                        ...
                                        <li class="col-sm-6">
                                            <label>
                                                <input placeholder="heure rendez-vs" type="text"
                        ...
                        ?>
                                        ...
                                        <li class="col-sm-12">
                                            <button type="submit" class="btn" name="submit" id="submit">RESERVEZ
       </button>
                                        </li>
                                </form>
                            </div>
