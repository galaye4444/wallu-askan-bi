...
if(isset($_POST[submit]))
{
	if(isset($_GET[editid]))
	{
		...
		{
			echo "<script>alert('L\'horaire  du Docteur a ete mis à jour avec succès...');</script>";
		}
		else
		{
	...
	if($qsql = mysqli_query($con,$sql))
	{
		echo "<script>alert('l\'horaire du Docteur est ajouter avec success...');</script>";
	}
	else
	{
		echo mysqli_error($con);
...
<div class="container-fluid">
	<div class="block-header">
            <h2>Ajouter Nouveau horaire du Docteur</h2>
   ...
   <form method="post" action="" name="frmdocttimings" onSubmit="return validateform()">
    <table class="table table-hover">
      <tbody>
        ...
        <tr>
          <td height="36" colspan="2" align="center"><input class="btn btn-default" type="submit" name="submit" id="submit" value="Enregistrer" /></td>
        </tr>
      </tbody>
    </table>
    </form>
