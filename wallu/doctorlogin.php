...
if(isset($_POST[submit]))
{
	...
	else
	{
		...
		<strong>Oh !</strong>Changer quelques choses et essayer de soumettre à nouveau
.
	</div>";
	}
}
...
?></div>
    ...
    <div class="card">
        <h1 class="title"><span>Wallu askan wi</span>Login <span class="msg">Bonjour, Docteur!</span></h1>
        <div class="col-md-12">

    <form method="post" action="" name="frmadminlogin" id="sign_in" onSubmit="return validateform()">
    <div class="input-group"> <span class="input-group-addon"> <i class="zmdi zmdi-account"></i> </span>
                    <div class="form-line">
					<input type="text" name="loginid" id="loginid" class="form-control" placeholder="Utilisateur" /></div>
                </div>
                ...
                <div>
					...
					<input type="submit" name="submit" id="submit" value="Login" class="btn btn-raised waves-effect bg-red" /></div>
...
function validateform()
{
	...
	{
		alert("Login ID invalide..");
		document.frmdoctlogin.loginid.focus();
		return false;
	}
	else if(document.frmdoctlogin.password.value == "")
	{
		alert("votre mot de passe doit pas etre vide..");
