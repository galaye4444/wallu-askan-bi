...
<form method="post" action="" name="frmadminprofile" onSubmit="return validateform()">
		...
		<div class="body">
			<div class="row clearfix">
				<div class="col-sm-12">   
					<div class="form-group">
						<div class="form-line">
							<input class="form-control" type="password" name="oldpassword" id="oldpassword" placeholder="Actuel Mot de Passe" />
						</div>
					</div>
			...
			<div class="col-sm-12">                              
				 <div class="form-group">
						<div class="form-line">
							<input class="form-control" type="password" name="password" id="password" placeholder="Confirmation Mot de Passe" />
						</div>
					</div>
					</div>                          
			</div>                     
			<div class="col-sm-12">
				<input type="submit" class="btn btn-raised btn-primary" name="submit" id="submit" value="Enregistrer" />
