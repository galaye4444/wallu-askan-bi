...
if(isset($_POST[submit]))
{
	if(isset($_GET[editid]))
	{
		...
		{
			echo "<script>alert('docteur enregistrer avec success...');</script>";
		}
		else
		{
	...
	if($qsql = mysqli_query($con,$sql))
	{
		echo "<script>alert('Doctor ajouter avec success...');</script>";
	}
	else
	{
		echo mysqli_error($con);
		...
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<div class="card">
				...
				<form method="post" action="" name="frmdoct" onSubmit="return validateform()" style="padding: 10px">
					...
					<div class="form-group"><label>Nom Docteur</label> 
					<div class="form-line">
					...
					<div class="form-group"><label>ID Connect</label> 
					<div class="form-line">
					...
					<input class="btn btn-primary" type="submit" name="submit" id="submit" value="Enregistrer" />
