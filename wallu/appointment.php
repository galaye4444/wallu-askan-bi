...
if(isset($_POST[submit]))
{
  if(isset($_GET[editid]))
  {
   ...
   {
    echo "<script>alert('rendez-vous enregistrer avec success...');</script>";
}
else
{
...
<div class="container-fluid">
    <div class="block-header">
        <h2>Carnet des rendez-vous</h2>
    </div>
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    <h2>Information des rendez-vous</h2>
                ...
                <form method="post" action="" name="frmappnt" onSubmit="return validateform()">
                                    ...
                                    <div class="form-line">
                                      ...
                                      else
                                      {
                                        ...
                                        <select name="select4" id="select4" class=" form-control show-tick">
                                            <option value="">Selectionnez Patient</option>
                                            <?php
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <select name="select6" id="select6" class=" form-control show-tick">
                                            <option value="">Selectionnez Docteur</option>
                                            <?php
                    ...
                    ?>
                            ...
                            <div class="col-sm-12">
                                ...
                                <input type="submit" class="btn btn-raised btn-primary" name="submit" id="submit"
                                    value="Enregistrer" />
