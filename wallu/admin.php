...
if(isset($_POST[submit]))
{
	if(isset($_GET[editid]))
	{
		...
		if($qsql = mysqli_query($con,$sql))
		{
			...
			Admin mise a jour avec success
			</div>";
		}
		else
		{
	...
	else
	{
		...
		{
			echo "<div class='alert alert-success'>
			Mise a jour Admin ajouter avec success
			</div>";
		}
		else
		{
				...
				<form method="post" action="" name="frmadminprofile" onSubmit="return validateform()">
					...
					<div class="body">
						...
						<div class="row clearfix"> 
							<div class="col-sm-12">                              
								<div class="form-group">
									<label>Confirmation Mot de Passe Admin</label>
									<div class="form-line">
						...
						<div class="col-sm-12">
							<input type="submit" class="btn btn-raised btn-primary" name="submit" id="submit" value="Submit" />
