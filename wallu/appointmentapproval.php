...
<div class="card ">
    ...
    <h2>Process d'approbation des rendez-vous</h2>
  ...
  echo "<option value='$rsdepartment[departmentid]'>$rsdepartment[departmentname]</option>";
        ...
        <tr>
          <td>Description du Rendez-Vous</td>
...
function validateform()
{
	...
	{
		alert("Le nom du patient doit pas etre vide..");
		document.frmappnt.select4.focus();
		return false;
	}
	else if(document.frmappnt.select3.value == "")
	{
		alert("Le type de salle doit pas etre vide..");
